...
@Component({
  ...
  templateUrl: './achat-article.component.html',
  styleUrls: ['./achat-article.component.css']
})
export class AchatArticleComponent {
  ...
  ngOnInit(): void {
    ...
    this.http.get('http://localhost:8087/articleVendu/acheteur/' + val).subscribe({
